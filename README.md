...
_Tools: Jupyter Notebooks, Python, Google Maps API, Google Tag Manager, Google Analytics 4, Looker Studio_

![Alcoholic beverage map](assets/alcoholic beverage map july 2024.png)
